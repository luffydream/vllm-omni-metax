...
class Qwen3TTSCode2Wav(nn.Module):
    ...
    def _ensure_speech_tokenizer_loaded(self) -> None:
        ...
        # Keep CUDA Graph opt-in: MetaX/MACA
        # can hang during graph warmup/capture for the speech decoder.
        enable_code2wav_cudagraph = os.getenv("VLLM_OMNI_METAX_ENABLE_CODE2WAV_CUDAGRAPH") == "1"
        if enable_code2wav_cudagraph and hasattr(decoder, "enable_cudagraph"):
